...
<div class="container d-flex justify-content-center">
  <div class="row">
    <ul class="list-group">
      <li class="list-group-item active d-flex justify-content-center"><?php echo $account->getType() ?></li>
      <li class="list-group-item">Amount : <?php echo $account->getAmount()?></li>
      <li class="list-group-item">Name : <?php echo $_SESSION['user']->getName()?></li>
    </ul>
</div>
</div>
